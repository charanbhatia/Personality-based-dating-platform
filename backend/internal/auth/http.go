...
func (h *Handler) RegisterRoutes(r *mux.Router, requireAuth func(http.Handler) http.Handler) {
	r.Handle("/auth/register", httpx.Wrap(h.Register)).Methods(http.MethodPost)
	r.Handle("/auth/login", httpx.Wrap(h.Login)).Methods(http.MethodPost)
	r.Handle("/auth/refresh", httpx.Wrap(h.Refresh)).Methods(http.MethodPost)
	r.Handle("/auth/password/forgot", httpx.Wrap(h.ForgotPassword)).Methods(http.MethodPost)
	r.Handle("/auth/password/reset", httpx.Wrap(h.ResetPassword)).Methods(http.MethodPost)
